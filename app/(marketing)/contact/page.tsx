      ...
      <section className="section">
        <div className="container split-contact reveal">
          <div className="contact-left">
            ...
            <p>
              Share a little about your team, your context, and where you’d like
              to be. We’ll follow up with ideas and a practical next step.
            </p>
            <div style={{ marginTop: "3rem" }}>
              ...
              <p>
                <a
                  href="mailto:fraterai@fraterailabs.com"
                  style={{
                    color: "#fff",
                    textDecoration: "none",
                    fontSize: "1.25rem",
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    transition:
                      "transform 120ms var(--ease-out), background-color 180ms var(--ease-out)",
